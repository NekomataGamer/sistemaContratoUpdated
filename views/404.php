...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo BASE_URL;?>assets/assets/img/favicon.png">
    ...
    <!-- DashForge CSS -->
    <link rel="stylesheet" href="<?php echo BASE_URL;?>assets/assets/css/dashforge.css">
    <link rel="stylesheet" href="<?php echo BASE_URL;?>assets/assets/css/dashforge.auth.css">
  </head>
  <body>
    ...
    <header class="navbar navbar-header navbar-header-fixed">
      ...
      <div class="navbar-brand">
        <a href="<?php echo BASE_URL;?>assets/index.html" class="df-logo">dash<span>forge</span></a>
      </div><!-- navbar-brand -->
    ...
    <div class="content content-fixed content-auth-alt">
      <div class="container ht-100p tx-center">
        <div class="ht-100p d-flex flex-column align-items-center justify-content-center">
          <div class="wd-70p wd-sm-250 wd-lg-300 mg-b-15"><img src="https://via.placeholder.com/1260x840" class="img-fluid" alt=""></div>
